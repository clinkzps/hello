 ...
 * @param <T> 操作的实体类型
 */
public class PoBaseDAO<T extends BaseEntity> extends HibernateBaseDAO<T>{
	 ...
	 */
	@Autowired
	public void initSessionFactory(@Qualifier(DBQualifiers.PO_SF) SessionFactory sessionFactory){
